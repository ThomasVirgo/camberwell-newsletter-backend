...
SECRET_KEY = 'django-insecure-my7b-pahwk8&!h(3-s(b!=982l5g$)p#d*k5c8)q37ta2&*qf-'
...
GOOGLE_DRIVE_STORAGE_MEDIA_ROOT = 'images'
...
EMAIL_FROM = os.environ.get('EMAIL_HOST')
EMAIL_BCC = 'tomcvirgo@gmail.com'
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False
